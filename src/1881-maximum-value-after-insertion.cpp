...
// string, and an integer digit x. The
// digits in n and the digit x are in the inclusive range [1, 9], and n may
// represent a negative number.
//
// You want to maximize n's numerical value by inserting x anywhere in the
// decimal representation of
// n. You cannot insert x to the left of the
// negative sign.
//
...
public:
    string maxValue(string n, int x) {
        ...
        return n.substr(0, insIdx) + (char)(x + '0') + n.substr(insIdx);
    }
};
